...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="data/stitch/dbinfos_train_11sweeps_withvelo.pkl",
    sample_groups=[
        dict(car=2),
        dict(truck=3),
        dict(bus=4),        
...
train_anno = "data/stitch/infos_train_11sweeps_withvelo_filter_True.pkl"
val_anno = "data/stitch/infos_val_11sweeps_withvelo_filter_True.pkl"
test_anno = None
