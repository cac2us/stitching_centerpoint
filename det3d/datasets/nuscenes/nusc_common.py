...
def create_nuscenes_infos(root_path, version="v0.3-stitch", nsweeps=1, filter_zero=True):
    nusc = NuScenes(version=version, dataroot=root_path, verbose=True)
    available_vers = ["v1.0-trainval", "v1.0-test", "v1.0-mini", "v0.3-stitch"]
