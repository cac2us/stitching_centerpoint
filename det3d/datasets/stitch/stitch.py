...
from det3d.datasets.stitch.stitch_common import (
...
class StitchDataset(PointCloudDataset):
    NumPointFeatures = 3  # x, y, z, intensity, ring_index
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(StitchDataset, self).__init__(
        ...
        self._num_point_features = StitchDataset.NumPointFeatures
        ...
        self.eval_version = "detection_stitch_2023"
    ...
    def evaluation(self, detections, output_dir=None, testset=False):
        ...
        if not testset:
            ...
            detail = {}
            result = f"Stitch {version} Evaluation\n"
